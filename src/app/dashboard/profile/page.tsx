              ...
              <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Калькулятор помогает определить объем жидкости в бутылке по весу. Введите вес полной бутылки, пустой бутылки и текущий вес. Система рассчитает объем и позволит отправить результат в активную инвентаризацию.
                    </p>
                  </div>
                  <div>
